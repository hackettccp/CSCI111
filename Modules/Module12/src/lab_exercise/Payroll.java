 ...
 * Enter the hourly wage of these employees (they will all have the same hourly wage.)
 * Create an array to hold the number of hours for each employee.
 * Prompt the user for each employee's hours. Store these values to an array.
